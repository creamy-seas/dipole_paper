%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%kbordermatrix MUSE BE PLACED IN /usr/local/texlive/2016/texmf-dist/tex/latex/base
%and then run sudo -s texhash to load it up
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% Geometry
\usepackage{geometry}	\geometry{top=25mm}		\geometry{bottom=35mm}		\geometry{left=30mm}	\geometry{right=20mm}
...
\hypersetup{
	unicode=true, 
	pdftitle={Primary insights into the `dipole' qubit}, 
