...
\bibitem{gittins1989} John  C Gitins, Multi-armed  bandit allocation indices,  Chichester, New
  York: Wiley, (1989)
        
\bibitem{reed2011} {M.  D. Reed, L. DiCarlo, S. E. Nigg, L. Sun, L.  Frunzio, S. M. Girvin and
...
\bibitem{honigl2018} H\"onigl-Decrinis T., Antonov I. V., Shaikhaidarov, R. and Antonov, V. N.
...
\bibitem{phaseExp}  Quantum  processing involves  manipulating  the  state  of a  qubit,  $\Psi$,
  changing the relative state population, $\ensuremath{|\alpha|}  \le 1$, and phase, $\varphi$, between the
  ground, \iket{0}, and excited, \iket{1}, states:
  \begin{equation}
    \label{eq:4}
...
\bibitem{manucharyan2009} {Vladimir  E. Manucharyan and Jens  Koch and Leonid I.   Glazman and
    Michel H. Devoret}, {Science}, \textbf{326}, 113 (2009)

\bibitem{devitt2016} Devitt, Simon J., Phys. Rev. A, {94}, {032329} (2016)

\bibitem{phase}  Using the  commutation  relation  for conjugate  number  and phase  operators
  ...
  meaning that the exponential phase operator is a ladder operator for the \iket{n} state:
...
\bibitem{rabi} The Hamiltonian during driving is a combination of the qubit's two-level system
  \begin{equation}
    \label{eq:rabi1}
...
\bibitem{lor5b} http://microchem.com/pdf/PMGI-Resists-data-sheetV-rhcedit-102206.pdf
