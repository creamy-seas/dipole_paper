...
structures.   We first  use  \red{argon etching}  to  remove oxide  layers  for good  galvanic
...
amplifiers facilitate power conversion between  the laboratory equipment and qubit microwaves.
We surround each temperature stage of the system with a case, wrapping it like a Russian doll,
that thermally shield  from higher stages.  Prior to  performing characterization measurement,
we took the microwave transmission spectrum with  the qubit detuned, and corrected all further
measurements by this background transmission profile.
