...
sensitivity   and   allows   \iket{1}\ilra   \iket{2}   transitions   at   degeneracy   points
...
$\tau_{\text{dec}}$  is only  \iunit{42}{ns}, but  it can  be substantially  improved.  With  the
