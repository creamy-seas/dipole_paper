...
% /usr/local/texlive/2016/texmf-dist/tex/latex/base     and
% then run sudo -s texhash to load it up
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\documentclass[%
reprint,
% superscriptaddress,    groupedaddress,   unsortedaddress,
% runinaddress, frontmatterverbose, preprint,
...
%%% Geometry
\usepackage{geometry}                   \geometry{top=25mm}
\geometry{bottom=30mm}                 \geometry{left=30mm}
\geometry{right=20mm}
...
\hypersetup{ unicode=true,  pdftitle={Primary insights into
    the   `dipole'    qubit},   pdfauthor={Ilya   Antonov},
  pdfsubject={Qubits},      pdfcreator={Ilya      Antonov},
  pdfkeywords={Qubits} {} {},
