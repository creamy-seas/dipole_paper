...
two states,  \iket{1} and \iket{2}.  Microwaves  in the transmission line,  carrying a voltage
...
2. \iket{1}~\ilra~\iket{2} transitions  stimulated by this driving, set up  a qubit voltage of
...
\iket{1}\ilra \iket{2}  transitions at these  optimal working  points - transitions  which are
