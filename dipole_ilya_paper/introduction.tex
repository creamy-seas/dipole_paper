...
Flux qubit architectures have been  developed to address this decoherence problem
...
evidence for: strong anharmonicity with  respect to the \iket{1}\ilra\iket{2} and
\iket{2}\ilra\iket{3}  transitions;  weak  flux   dependence  of  the  transition
energies close  to the  degeneracy point; compliance  of the  experimental energy
spectrum with simulations and outstanding features of the \iket{1}~\ilra~\iket{2}
dipole transition.
