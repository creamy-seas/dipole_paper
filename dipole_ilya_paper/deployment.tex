...
\begin{figure}[h]
  \centering \includegraphics[height = 4.5cm]{fig2.png}
...
\iket{2}.  Because of this  depopulation, the probe signal is no longer  absorbed to drive the
\iket{1}\ilra \iket{2} transmission,  and it's transmission moves out of  the resonance dip in
...
\noindent  The eigenenergies  calculated from  the  resulting Hamiltonian  using \iunit{E_J  =
  91.0}{GHz}, \iunit{E_C = 13.50}{GHz}, \iunit{\alpha = 1.023}{}, \iunit{\eta = 1.011}{}, are compared
...
fabrication.
  ...
  \begin{figure}[h]
    \includegraphics[height = 4.5cm]{fig5}
